...
export function PartnersHero() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-zinc-200 bg-white translate-x-30">
      ...
      {/* Բովանդակություն (Content) - z-20-ով դնում ենք ամենավերևում */}
      <div className="relative z-20 container-x py-24 md:py-32 p-4">
        ...
        <h1 className="mt-8 max-w-4xl text-4xl md:text-6xl font-bold tracking-tight leading-[1.1] text-zinc-900">
          {pp.title[language]}{" "}
        ...
        <p className="mt-6 max-w-3xl text-base md:text-lg leading-relaxed text-emerald-600 font-medium">
          {pp.description1[language]}
        </p>

        <p className="mt-4 max-w-3xl text-sm md:text-base leading-relaxed text-zinc-700">
          {pp.description2[language]}
        </p>

        <p className="mt-4 max-w-3xl text-sm md:text-base leading-relaxed text-zinc-600">
